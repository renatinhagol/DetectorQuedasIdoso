...
// aqui tem o filtro do banco de dados -- pode ser alterado  --- aqui ele retorna todos os campos da tabela. o mais importante é o email que vai ser enviado.
$sqlconsulta =  "select * from responsavel where id = 1 ";

$result = $conn->query($sqlconsulta);
//Aqui ele vai percorrer o retorno do select e se retornar 3 emails ele vai enviar 3 vezes 1 para cada email
if ($result->num_rows > 0) {
	while($row = $result->fetch_assoc()) {
		...
		// Esse email é padrao pois vai significar que foi o sistema que enviou o email
		...
		/* abaixo as veriaveis principais, que devem conter em seu formulario -- modelo do email*/
